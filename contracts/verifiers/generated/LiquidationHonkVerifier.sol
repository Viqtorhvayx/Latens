...
//   cd circuits/liquidation_eligibility && nargo compile \
//     && bb write_vk -t evm -b target/liquidation_eligibility.json -o target/ \
//     && bb write_solidity_verifier -k target/vk -o target/Verifier.sol
// Generated from circuits/liquidation_eligibility (bb 6.0.0-nightly.20260905, nargo
// 1.0.0-beta.26). The only hand-edit applied is renaming the bottom-level `HonkVerifier`
// contract to `LiquidationHonkVerifier`, so this file can coexist with
// SolvencyHonkVerifier.sol and CommitmentHonkVerifier.sol in one Hardhat compilation.
// Every OTHER top-level name in this file (Honk, FrLib, RelationsLib, ZKTranscriptLib,
// CommitmentSchemeLib, BaseZKHonkVerifier, Errors, HonkVerificationKey, and the file-level N
// / LOG_N / VK_HASH / NUMBER_OF_PUBLIC_INPUTS constants) is IDENTICAL, unrenamed, across all
// three generated files — deliberately left alone rather than risk a mass rename across
// ~2500 lines of generated cryptographic verifier code. This is safe for Solidity
// compilation (each file is its own source unit; nothing imports two of these files into
// one file), but means any JS/TS code referencing these shared names by BARE name (e.g.
// `ethers.getContractFactory("RelationsLib")`) is ambiguous once more than one of these
// files is loaded — use Hardhat's fully-qualified name instead:
// `"contracts/verifiers/generated/LiquidationHonkVerifier.sol:RelationsLib"`. See the tests
// under test/ for the working pattern.
pragma solidity >=0.8.21;

uint256 constant N = 16384;
uint256 constant LOG_N = 14;
uint256 constant NUMBER_OF_PUBLIC_INPUTS = 20;
uint256 constant VK_HASH = 0x145381351eb8e6dc9b5b4dee6ed8fc6479b3cb6e54142532329376eb0797525a;
library HonkVerificationKey {
    function loadVerificationKey() internal pure returns (Honk.VerificationKey memory) {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            ql: Honk.G1Point({ 
               x: uint256(0x0ea0d461d3adc86e22704fba4cdea24069be0a5ac62db7b80e1cea5af39a15c0),
               y: uint256(0x1b9c37713936741578e33d7cc1aeeea9aec2602712ea1152099890ac59303f51)
            }),
            qr: Honk.G1Point({ 
               x: uint256(0x2fe96e9f8d9a3dc9feba83e3c5ed5e19f21ab3c5c5d9a396838ebd81c9c24dc8),
               y: uint256(0x15833b858933bb3d374a69f6e3f43625dbab304b8009168d9c14552eaccd03e1)
            }),
            qo: Honk.G1Point({ 
               x: uint256(0x114af3e03226aff08733f37d1ae28de969504fa885487b1082cf902406e97678),
               y: uint256(0x19db7bf048572ec96889ca94ce388b0144a65eb7e401c2a576c03445e22a0866)
            }),
            q4: Honk.G1Point({ 
               x: uint256(0x045406f91454e7520622e1bbf79d5f967f541e284c0d110e334b2ea6144612e1),
               y: uint256(0x1ca6411612eae376129413af86e10322b173db2651c34eb9aebbb18dbf0e8351)
            }),
            qm: Honk.G1Point({ 
               x: uint256(0x03b84740688f107851035852e5b7f14fc28275d1c810d988d1d3986ca581d927),
               y: uint256(0x03b345939185c23b95a27b5436a6c00d6db0fc1ba0054496bbbb5aebaede4b85)
            }),
            qc: Honk.G1Point({ 
               x: uint256(0x2d5e76be3905cec063b95d3e6041ccf526f86a9d22498257a4ff57d76db29bb9),
               y: uint256(0x16a98dddf03d6792f13339bd8e97fef9cf76e3738838d177fe24a360f15d4ab7)
            }),
            qLookup: Honk.G1Point({ 
               x: uint256(0x1e1228ef27728e0c75ce4857670e3e4dbb67c61cd89e15817ebc7a7bb7fda85d),
               y: uint256(0x04feb6455378f3084a330a21e3d95a03529b714ca13d6a441d260db00d242cb7)
            }),
            qArith: Honk.G1Point({ 
               x: uint256(0x1509c6709a7ccaddf6fe803f8a5ab81614132dd4372755c2a30642a6f909c396),
               y: uint256(0x2338e208dd4f12fe1a9737f4b3c6f3ab185f6951056d38292bedee683aa49150)
            }),
            qDeltaRange: Honk.G1Point({ 
               x: uint256(0x